...
export default function SupportLayout({ children, title = 'Dashboard', breadcrumb }) {
  const [mobileOpen, setMobileOpen] = useState(false)

  return (
    <div className="bf-shell min-h-svh">
      <SupportSidebar mobileOpen={mobileOpen} onClose={() => setMobileOpen(false)} />
      <div className="flex min-h-svh min-w-0 flex-col lg:pl-[260px]">
        <PortalTopbar
          title={title}
          breadcrumb={breadcrumb}
          notificationsTo="/support/notifications"
          profileTo="/support/profile"
          fallbackName="Priya Nair"
          fallbackRole="Customer Experience"
