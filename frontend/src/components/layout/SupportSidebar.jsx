...
const navItems = [
  ...
  { label: 'Support Tickets', to: '/support/tickets', icon: Ticket },
...
export default function SupportSidebar({ mobileOpen, onClose }) {
  const { user } = useAuth()
      ...
      <div className="mt-auto shrink-0 border-t border-[#e8ecf1] bg-white p-4">
        ...
        >
          ...
          <div className="min-w-0">
            ...
            <p className="truncate text-[11px] text-[#6b7280]">Customer Experience</p>
          </div>
        </Link>
