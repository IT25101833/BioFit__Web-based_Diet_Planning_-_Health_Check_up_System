...
| Stored Function/Procedure | 15 | Working routine with validation | `fn_CalculateBMI`, `sp_CreateAppointment` | scripts 07–08, 11 | **Implemented — requires execution** |
| Trigger | 15 | Meaningful, preferably set-based | `trg_health_metrics_audit` | scripts 09, 11 T07–T08 | **Implemented — requires execution** |
| Viva & Demonstration | 10 | Explain design | Viva Q&A from final objects | REPORT_Viva.md | **Draft ready** |
